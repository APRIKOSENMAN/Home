...
* Bei Änderungen an der Architektur: PROJECT\_OVERVIEW.md aktualisieren
* Bei jeder Änderung an einer Komponente (Aussehen, Name, Verhalten): KOMPONENTEN.md und KOMPONENTEN\_INVENTAR.md mitaktualisieren
...
* Einzelne Code-Dateien sollten 300 Zeilen nicht überschreiten.
* Wenn eine Datei größer wird, schlag eine Aufteilung vor, bevor du weitere Funktionen hinzufügst.
* Lieber mehrere kleine Dateien mit klarem Zweck als eine große Datei, die alles macht.
* app.js (oder vergleichbare zentrale Datei) soll eine reine Koordinations-Datei sein, keine Logik-Datei."
